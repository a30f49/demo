...
package com.dianjiang.widget.pickerview;

import java.util.LinkedList;
import java.util.List;

import android.util.DisplayMetrics;
import com.dianjiang.widget.pickerview.internal.*;
...
import com.dianjiang.widget.pickerview.support.DensityUtils;
import com.dianjiang.widget.pickerview.support.ScreenUtils;
...
public class WheelView extends View {
	...
	/** Label offset */
	private static int DEFAULT_LABEL_OFFSET = 20;
